...
parser.add_argument('--data_dir', default='D:\\AI\\vision\\data\\masks\\anno', help="Directory with the SIGNS dataset")
parser.add_argument('--output_dir', default='D:\\AI\\vision\\data\\masks\\hairanno', help="Where to write the new data")
...
def resize_and_save(filename, output_dir, size=SIZE):
    ...
    s=filename.split('\\')[-1]
    if(s[-5]=='r' and s[-6]=='i'and s[-7]=='a' and s[-8]=='h'):
...
if __name__ == '__main__':
    ...
    train_data_dir = os.path.join(args.data_dir, fol)
    ...
    output_dir_split = os.path.join(args.output_dir, '0')
