...
parser.add_argument('--data_dir', default='D:\\AI\\vision\\data\\SIGNS', help="Directory with the SIGNS dataset")
parser.add_argument('--output_dir', default='D:\\AI\\vision\\data\\64x64_SIGNS', help="Where to write the new data")
